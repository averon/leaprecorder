...
(function() {
  window.recorder.controller('Controls', [
    '$scope', '$location', '$document', '$analytics', 'Recording', 'RecordingCompressor', 'RecordingService', function($scope, $location, $document, $analytics, Recording, RecordingCompressor, RecordingService) {
      var track;
      ...
      bindHotkeys();
      $('#saveRecording').on('shown.bs.modal', unbindHotkeys);
      $('#saveRecording').on('hidden.bs.modal', bindHotkeys);
